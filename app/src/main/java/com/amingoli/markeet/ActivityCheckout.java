...
import com.amingoli.markeet.model.ProductOrder;
import com.amingoli.markeet.model.ProductOrderDetail;
...
public class ActivityCheckout extends AppCompatActivity {
    ...
    private void iniComponent() {
        ...
        date_shipping.setOnClickListener(new View.OnClickListener() {
            @Override
